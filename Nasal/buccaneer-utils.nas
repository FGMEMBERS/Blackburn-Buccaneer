...
rainingNode = props.globals.getNode("sim/model/Blackburn-Buccaneer/raining", 1);
...
setprop("sim/model/Blackburn-Buccaneer/controls/lp_rotating",0);
setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed",0);
setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed_test",0);
setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed[1]",0);
setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed_test[1]",0);
...
var observer_head_brg_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/observer-head/rel-brg-deg", 1);
var observer_head_elev_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/observer-head/elev-deg", 1);
var observer_head_look_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/observer-head/look", 1);
var observer_head_visor_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/observer-head/visor-pos-norm", 1);
var pilot_head_brg_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/pilot-head/rel-brg-deg", 1);
var pilot_head_elev_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/pilot-head/elev-deg", 1);
var pilot_head_look_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/pilot-head/look", 1);
var pilot_head_visor_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/pilot-head/visor-pos-norm", 1);
...
#		"Aircraft/Blackburn-Buccaneer/Formations",
...
aircraft.livery.init("Aircraft/Blackburn-Buccaneer/Models/Liveries",
	...
	wiper = aircraft.door.new("sim/model/Blackburn-Buccaneer/wiper", 2);
...
var update = func {
    ...
    if (n1 >= 5 or n2 >= 5 or n11 >= 5 or n21 >= 5)
        setprop("sim/model/Blackburn-Buccaneer/controls/lp_rotating",1);
    else
        setprop("sim/model/Blackburn-Buccaneer/controls/lp_rotating",0);

    test_lp_ospeed  = getprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed_test");
    test_lp_ospeed1 = getprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed_test[1]");

    if ( n2 > 98 or test_lp_ospeed == 1)
        setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed", 1);
    else
        setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed", 0);

    if ( n21 > 98 or test_lp_ospeed1 == 1)
        setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed[1]", 1);
    else
        setprop("sim/model/Blackburn-Buccaneer/controls/lp_ospeed[1]", 0);
...
var Flow = {
	new : func ()
	{
		...
		obj.flow = props.globals.getNode("sim/model/Blackburn-Buccaneer/flow", 1);
...
#
	...
	new : func (name)
	{
		...
		obj.name = name;
		obj.head_brg_node   = props.globals.getNode("sim/model/Blackburn-Buccaneer/" ~ name ~"-head/rel-brg-deg", 1);
		obj.head_elev_node  = props.globals.getNode("sim/model/Blackburn-Buccaneer/" ~ name ~"-head/elev-deg", 1);
		obj.head_look_node  = props.globals.getNode("sim/model/Blackburn-Buccaneer/" ~ name ~"-head/look", 1);
		obj.head_visor_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/" ~ name ~"-head/visor-pos-norm", 1);
		obj.arm_brg_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/" ~ name ~"-arm/rel-brg-norm", 1);
		obj.arm_elev_node = props.globals.getNode("sim/model/Blackburn-Buccaneer/" ~ name ~"-arm/elev-norm", 1);
